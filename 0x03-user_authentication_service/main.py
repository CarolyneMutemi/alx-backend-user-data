...
def register_user(email: str, password: str) -> None:
    ...
    second_query = requests.post('http://localhost:5000/users',
                                 data=payload, timeout=5)
    ...
    third_query = requests.post('http://localhost:5000/users',
                                data=new_payload, timeout=5)
